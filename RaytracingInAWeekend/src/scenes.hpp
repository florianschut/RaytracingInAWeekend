...
namespace scene
{
	...
	Hittable* CornelScene()
	{
		...
		list[i++] = new Translate(new RotateY( new Box(glm::vec3(0, 0, 0), glm::vec3(165, 165, 165), white), -18.f), glm::vec3(130, 0, 65));
		list[i++] = new Translate(new RotateY( new Box(glm::vec3(0, 0, 0), glm::vec3(165, 330, 165), white), 15.f), glm::vec3(265, 0, 295));
