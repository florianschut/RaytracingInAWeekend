...
namespace scene
{
	...
	std::shared_ptr<Hittable> CornelScene(Camera& camera, std::shared_ptr<Hittable>& lights, float aspect)
	{
		...
		auto square_light = std::make_shared<FlipNormals>(std::make_shared<XZRect>(213.f, 343.f, 227.f, 332.f, 554.f, light));
		...
		auto box1 = std::make_shared<Box>(glm::vec3(0, 0, 0), glm::vec3(165.f, 330.f, 165.f), white);
